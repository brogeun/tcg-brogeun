...
export const SURVIVAL_RATES=Object.freeze({multiplier:1.25,hunger:Object.freeze({idle:.055,moving:.095}),thirst:Object.freeze({idle:.085,moving:.14}),warning:20,saveMinimum:25,depletionDamageFraction:.08});
...
export function newSave(){return ensureSupplies({version:SAVE_VERSION,starter:null,party:[],collection:[],dex:{},inventory:{'poke-ball':30,'great-ball':5,potion:8,revive:3,'fishing-rod':1},coins:300,region:'camp',position:[0,10],discovered:['camp'],bosses:[],flags:{},quests:{},survival:{hunger:100,thirst:100,drops:[]},settings:{volume:.4,quality:'auto',camera:1,motion:true,shake:.65,vibration:false,locale:'ko-KR'},playTime:0,worldTime:9,weather:'clear',savedAt:null});}
